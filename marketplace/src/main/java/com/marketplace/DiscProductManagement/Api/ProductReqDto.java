...
public record ProductReqDto(String categoryName, String subCategoryName, int productOrderMinimum, String discTitle, Disc.ProductConditionEnum productCondition, String description, Disc.UnitOfProductEnum unitOfProduct, String publisher) {
}
